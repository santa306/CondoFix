...
class ViewDettaglioInterventoFornitore extends ViewBase
{
    ...
    public function mostra(Intervento $intervento, array $note, array $foto): void
    {
        ...
        $this->render('dettaglio_intervento_fornitore.tpl');
    }
}
